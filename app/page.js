...
export default function ChatInterface() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("messageHistory", JSON.stringify(messages.map(msg => ({ ...msg, content: typeof msg.content === 'string' ? msg.content : '' }))));
      ...
      // Ensure content is a string before serialization
        ...
        <ScrollArea className="flex-1 p-4 py-16">
          {messages.length === 0 ? (
              ...
              >
                ...
                <h2 className="text-lg opacity-50">Ask a question to get started.</h2>
                <Feedback />
                <Link
                        ...
                        <div className="flex flex-col space-y-2">
                          ...
                          <div className="space-y-2">
                            {message.role === "assistant" ? (
                                <MDXRemote {...message.content} components={components} />
                            ) : (
